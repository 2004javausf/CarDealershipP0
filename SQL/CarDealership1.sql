...
CREATE TABLE CarDealership.`customer` (
...
CREATE TABLE CarDealership.`employee` (
...
CREATE TABLE `CarDealership`.`customer_bid` (
...
CREATE TABLE `CarDealership`.`customer_owned_cars` (
    `customer_id` int NOT NULL,
	`car_id` int NOT NULL,
...
CREATE TABLE `CarDealership`.`dealer_payments` (
...
select * from `CarDealership`.`customer`;

select * from `CarDealership`.`car`;
select * from `CarDealership`.`customer_bid`;
